...
public class multiplication_table_grid_final extends PApplet {
...
class grid
{
  ...
  public void reset()
  {
    ...
    {
      tables.add(new table(x, y, multiplier));
      x += changepos;
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "multiplication_table_grid_final" };
    if (passedArgs != null) {
